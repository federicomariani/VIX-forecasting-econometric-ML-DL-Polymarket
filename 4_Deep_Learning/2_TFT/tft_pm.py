...
if __name__ == "__main__":
    ...
    # IMPORT DATASET
    # ---------------
    dataset = pd.read_csv(r"C:\Users\fede1\Desktop\Repo\0_Dataset\Polymarket_data\dataset_w_polymarket.csv")
    ...
    dataset_h = dataset.dropna(subset=predittori_w_pm + ["Close_VIX"]).reset_index(drop=True) # sostituire con predittori_w_pm
    ...
    time_varying_unknown_reals = [p for p in predittori_w_pm if p != "Weekday"] # sostituire con predittori_w_pm
    ...
    ranking = ranking[ranking["Variabile"].isin(predittori_w_pm)] # sostituire con predittori_w_pm
    ...
    importance_cv = importance_cv[importance_cv["Variabile"].isin(predittori_w_pm)] # sostituire con predittori_w_pm
    ...
    importance_bo = importance_bo[importance_bo["Variabile"].isin(predittori_w_pm)] # sostituire con predittori_w_pm
