...
for n in feature_sizes:
    ...
    idx_selected = [predittori.index(f) for f in selected_features] # da cambiare manualmente quando si utilizza predittori_w_pm
...
# -----------------------------------------------------
X_training = dataset_h.loc[:"2019-12-31", predittori] # questo "predittori" e quello successivo non occorre cambiarlo quando si utilizza predittori_w_pm
